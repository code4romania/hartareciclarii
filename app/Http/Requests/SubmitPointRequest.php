...
class SubmitPointRequest extends FormRequest
{
    public function rules(): array
    {
        $rules = match ($this->step) {
            'type', 'location' => $this->getTypeAndLocationRules(),
            'details' => $this->getDetailsRules(),
            'materials' => $this->getMaterialsRules(),
            'review' => array_merge(
                $this->getTypeAndLocationRules(),
                $this->getDetailsRules(),
                $this->getMaterialsRules(),
            ),
        };
    ...
    protected function getTypeAndLocationRules(): array
    {
        return [
    ...
    protected function getDetailsRules(): array
    {
        return [
    ...
    protected function getMaterialsRules(): array
    {
        return [
