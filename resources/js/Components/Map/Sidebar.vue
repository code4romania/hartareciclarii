<template>
    ...
    >
        ...
        <div class="p-4">
            ...
            >
                ...
                <span class="mt-1" v-text="$t('sidebar.search')" />
            </button>
        </div>
        ...
        <div class="p-4">
            ...
            >
                <span
                    class="p-1 rounded-full border-0 bg-green-500 text-end block absolute -top-0.5 end-2"
                    :class="{
                        hidden: !hasFiltersContent,
                        '': hasFiltersContent,
                    }"
                >
                </span>
                <desktop-filter-filters-icon></desktop-filter-filters-icon>
                <span class="mt-1" v-text="$t('sidebar.filters')" />
            </button>
        </div>
    </div>
    ...
    <div
        ...
        ref="filtersBox"
        :class="{
            flex: open && !this.filtersOpen,
            hidden: !open,
            'absolute lg:relative z-30': this.filtersOpen,
        }"
    >
        ...
        <div class="flex flex-col overflow-y-auto grow">
            ...
            <div class="p-4 mb-6 bg-gray-50">
                <label
                    ...
                    for="search-point"
                    v-text="$t('sidebar.search_point_label')"
                />
            ...
            <span v-if="hasResults">
                <div class="px-4 pb-4 mb-3 border-b">
                    ...
                    >
                        <div class="w-1/2 text-left" v-text="$tChoice('sidebar.results', totalPoints)" />

                        <div class="w-1/2 text-right">
                            <a
                                v-on:click="resetFilters()"
                                class="underline cursor-pointer text-primary"
                                v-text="$t('sidebar.filters_short_title')"
                            />
                        </div>
                    </div>
                </div>
                ...
                <template v-else>
                    <div class="px-4 pb-4 mb-3 border-b">
                        <span class="font-medium text-gray-900" v-text="$t('sidebar.filters_title')" />
                    </div>
                    <div class="px-6 pb-6">
                        <h3 class="flow-root">
                            ...
                            <button
                                ...
                                type="button"
                            >
                                <span class="font-medium text-gray-900" v-text="$t('sidebar.service_type_label')" />
                            </button>
                        </h3>
                    ...
                    <div v-if="getFilter('service_types')">
                        <div class="px-4 pb-4 mb-3 border-b">
                            <span
                                ...
                                v-text="$t('sidebar.collection_point_type_label')"
                            />
                        </div>
                    ...
                    <div v-if="getFilter('material_types')">
                        <div class="px-4 pb-4 mb-3 border-b">
                            <span class="font-medium text-gray-900" v-text="$t('sidebar.material_type_label')" />
                        </div>
                        ...
                        <div class="relative m-3 rounded-md shadow-sm">
                            ...
                            <input
                                id="search-point"
                                :placeholder="$t('sidebar.search_material_label')"
            ...
            <span v-else>
                <div class="px-4 pb-4 mb-3 border-b">0 {{ $t('sidebar.results') }}</div>
                <div class="px-6 pb-6">
                    <img
                    ...
                    <p
                        class="block mt-5 text-xs font-normal leading-6 text-center text-gray-900"
                        v-text="
                            $t('sidebar.no_results_found', {
                                query: searchParamsForFilters.search_key,
                            })
                        "
                    />
