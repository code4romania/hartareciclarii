	...
	<div class="">
		<div class="flex items-center justify-between">
			<h3 id="modal-title" class="text-2xl pl-5 py-3">{{
					CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.TITLE
				}}</h3>
		...
		<div class="flex items-center justify-between">
			<span class="py-10 text-sm px-5">{{ CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.SUBTITLE }}</span>
		</div>
					...
					<div class="flex">
						...
						<div class="ml-3">
							<h3 class="text-sm font-medium text-red-800">
								{{ CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.DESCRIPTION_NOT_FOUND }}</h3>
						</div>
					</div>
				</div>
			</template>
