<template>
	...
	<div class="h-screen flex items-center justify-center flex-col">
		<h3 class="text-2xl pl-5 py-3 text-black font-medium">
			{{CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.SUCCESS.TITLE}}
		</h3>
		<p class="mt-3 text-center text-sm font-medium text-gray-700">
			{{CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.SUCCESS.SUB_TITLE}}
		</p>
		<p class="mt-3">
		...
		<p class="mt-3 text-center text-sm font-medium text-gray-700">
			{{CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.SUCCESS.SUB_TITLE_UNDER_IMAGE}}
		</p>
		...
		<div class="bg-neutral-100 w-full mt-5 py-3 px-5 rounded-lg">
			...
			>
				<span class="w-full items-center inline-block mt-3">
					...
					{{CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.SUCCESS.WEBSITE}}
				</span>
			...
			>
				<span class="w-full items-center inline-block mt-3">
					...
					{{CONSTANTS.LABELS.REPORT_PROBLEM.OTHER_PROBLEM_STEP.SUCCESS.PHONE}}
				</span>
